...
public class ActivityDetalleResultado extends AppCompatActivity {
    ...
    private void sendMailContacto(){
        ...
        RequestParams rponer = new RequestParams();
        rponer.put("EMAIL",""+idpersona);
        rponer.put("MENSAJE", mensaje);
        rponer.put("REMITENTE", emailremitente);
        rponer.put("LANG",codLenguaje);


       Log.d("EMAIL",""+idpersona);
        Log.d("MENSAJE", mensaje);
        Log.d("REMITENTE", emailremitente);
        Log.d("LANG",codLenguaje);



        clientMail.post(SERVER_URL_MAIL,rponer, new JsonHttpResponseHandler()
        {
